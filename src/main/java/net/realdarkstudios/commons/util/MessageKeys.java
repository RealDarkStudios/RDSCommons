...
public class MessageKeys {
    ...
    public static final LocalizedMessages.Key LOCALIZATION_LOADED = key("plugin.localization_loaded");
    ...
    private static LocalizedMessages.Key key(String path, LocalizedMessages.StyleOptions styleOptions) {
        return new LocalizedMessages.Key(RDSCommons.getAPILocalization(), path, styleOptions);
    }
